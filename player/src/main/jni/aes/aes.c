...
void InvCipher_input_output(char *inut, char *output);

//private:
unsigned char *Cipher_uchar(unsigned char *input);

unsigned char *InvCipher_uchar(unsigned char *input);

void *Cipher_input_length(void *input, int length);    //=0
void *InvCipher_input_length(void *input, int length);

void Cipher_input_output(char *input, char *output);
...
void InvCipher_input_output(char *input, char *output) {
    unsigned char uch_input[1024];
    hexToUChar(input, uch_input);
    InvCipher_uchar(uch_input);
...
* @返回值： void
*********************************************/
void Bm53InvCipher(char *input, char *output) {
...
void *Cipher_input_length(void *input, int length) {
